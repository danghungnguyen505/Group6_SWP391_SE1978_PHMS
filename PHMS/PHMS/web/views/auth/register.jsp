...
<head>
    <meta charset="UTF-8">
    <title><fmt:message key="app.brand"/> - <fmt:message key="auth.register.title"/></title>
...
<body>
    ...
    <div class="language-switcher-fixed">
        <a href="${pageContext.request.contextPath}/language?lang=vi&redirect=/register"
           class="lang-btn ${currentLanguage == 'vi' ? 'active' : ''}">VN</a>
        <a href="${pageContext.request.contextPath}/language?lang=en&redirect=/register"
    ...
    <div class="register-wrapper">
        <div class="register-card">
            <div class="register-header">
                <h1 style="font-size: 2rem; font-weight: 800; color: #1e293b; margin-bottom: 0.5rem;"><fmt:message key="auth.register.createTitle"/></h1>
                <p style="color: #64748b;"><fmt:message key="auth.register.joinSubtitle"/></p>
            </div>
            ...
            <form action="register" method="post">
                <div class="register-grid">
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.register.fullName"/></label>
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.register.username"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.register.phone"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                    ...
                    <div class="form-group full-width">
                            <label class="label-micro"><fmt:message key="auth.register.address"/></label>
                            <div class="input-wrapper">
                                <div class="input-icon">
                    ...
                    <div class="form-group">
                            <label class="label-micro"><fmt:message key="auth.register.password"/></label>
                            <div class="input-wrapper">
                                <div class="input-icon">
                    ...
                    <div class="form-group">
                            <label class="label-micro"><fmt:message key="auth.register.confirmPassword"/></label>
                            <div class="input-wrapper">
                                <div class="input-icon">
                    ...
                    <div class="full-width">
                        <button type="submit" class="btn-register">
                            <span><fmt:message key="auth.register.btnNow"/></span>
                ...
                <div class="login-prompt">
                    <fmt:message key="auth.register.haveAccountPrompt"/> <a href="login"><fmt:message key="common.login"/></a>
                </div>
            </form>
        </div>
    </div>
