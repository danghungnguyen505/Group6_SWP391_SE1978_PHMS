...
<head>
    ...
    <title><fmt:message key="auth.profile.title"/> - <fmt:message key="app.brand"/></title>
...
<body>
    ...
    <div class="language-switcher-fixed">
        <a href="${pageContext.request.contextPath}/language?lang=vi&redirect=/profile"
           class="lang-btn ${currentLanguage == 'vi' ? 'active' : ''}">VN</a>
        <a href="${pageContext.request.contextPath}/language?lang=en&redirect=/profile"
    ...
    <div class="back-home-floating">
        <a href="${pageContext.request.contextPath}/home" class="back-home-btn">
            ...
            <fmt:message key="auth.profile.backToHome"/>
        </a>
    </div>
        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                <div class="profile-avatar-wrapper">
                    ...
                    <button class="btn-edit-avatar" title="<fmt:message key='auth.profile.avatar'/>">
                ...
                <form action="profile" method="post">
                    <div class="profile-grid">
                        <div class="form-group">
                            <label class="label-micro"><fmt:message key="auth.login.username"/></label>
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.register.email"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.profile.fullName"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            </div>
                            <input type="text" name="fullname" required class="form-input" value="${sessionScope.account.fullName}" required placeholder="<fmt:message key='auth.profile.updateFullName'/>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.profile.phone"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            </div>
                            <input type="text" name="phone" required class="form-input" value="${sessionScope.account.phone}" placeholder="<fmt:message key='auth.profile.updatePhone'/>">
                        </div>
                    </div>

                    <div class="form-group full-width">
                        <label class="label-micro"><fmt:message key="auth.profile.address"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            </div>
                            <input type="text" name="address" required class="form-input" value="${sessionScope.account.address}" placeholder="<fmt:message key='auth.profile.updateAddress'/>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="label-micro"><fmt:message key="auth.profile.password"/></label>
                        <div class="input-wrapper">
                            <div class="input-icon">
                    ...
                    <div class="profile-actions">
                        <button type="submit" class="btn-save">
                            <fmt:message key="auth.profile.saveChanges"/>
                        </button>
                        </div>
                        <div class="secondary-nav">
                            <a href="${pageContext.request.contextPath}/change-password" class="nav-link security">
                                ...
                                <fmt:message key="auth.profile.security"/>
                            </a>
