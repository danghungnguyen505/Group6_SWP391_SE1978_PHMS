...
public class MedicalRecordCreateController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int recordId = dao.createForVetReturnId(apptId, account.getUserId(), diagnosis, treatmentPlan);
            if (recordId > 0) {
                session.setAttribute("toastMessage", "success|Medical record created and appointment marked In-Progress.");
