...
@WebServlet(name = "EmergencyCompleteController", urlPatterns = {"/veterinarian/emergency/complete"})
public class EmergencyCompleteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ok) {
            session.setAttribute("toastMessage", "success|Emergency case marked as Completed.");
        } else {
