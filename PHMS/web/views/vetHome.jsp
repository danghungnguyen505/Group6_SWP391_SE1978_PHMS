<%-- 
    Document   : vetHome
    Created on : Jan 22, 2026, 3:03:26 AM
    Author     : zoxy4
--%>
...
<html>
    <head>
        ...
        <title>Veterinarian Dashboard - PHMS</title>
        <style>
            body {
            ...
            <div style="margin-top: 30px;">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li style="margin: 10px 0;">
                        <a href="${pageContext.request.contextPath}/checkin" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: white; text-decoration: none; border-radius: 4px;">
                            Check-in & Queue
                        </a>
                    </li>
                </ul>
