        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                <div class="profile-avatar-wrapper">
                    ...
                    <button class="btn-edit-avatar" title="Change avatar">
                ...
                <form action="profile" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="fullname" required class="form-input" value="${sessionScope.account.fullName}" required placeholder="Update your full name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="phone" required class="form-input" value="${sessionScope.account.phone}" placeholder="0912345678"
                                   pattern="0[0-9]{9}" minlength="10" maxlength="10" inputmode="numeric" title="Số điện thoại phải gồm đúng 10 chữ số và bắt đầu bằng 0">
                        </div>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="address" required class="form-input" value="${sessionScope.account.address}" placeholder="House number, street, area...">
                        </div>
                    </div>
