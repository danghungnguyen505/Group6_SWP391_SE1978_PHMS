...
/**
 * Controller for adding a new pet Single Responsibility: Handle pet creation
 * only
 */
...
public class AddPetController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = petDAO.addPet(account.getUserId(), name, species, history != null ? history : "" ,gender);
